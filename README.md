...
### Misc Tools
- [OpenRouter to Langfuse Model Pricing Sync](https://github.com/thiswillbeyourgithub/openrouter_cost_into_langfuse/): A Python script that automatically syncs model pricing data from OpenRouter to Langfuse's pricing page.
...
- [MediaDurationRecursiveChecker](https://github.com/thiswillbeyourgithub/MediaDurationRecursiveChecker): Media duration analysis tool that recursively scans directories to calculate total duration and size of media files while providing real-time processing estimates.
- [MediaMetadataExtractor](https://github.com/thiswillbeyourgithub/MediaMetadataExtractor): Metadata extraction tool for media files that provides comprehensive technical information in Excel and JSON formats, supporting various video and audio formats with a user-friendly GUI interface.
- [MediaSizeOrHashMatcher](https://github.com/thiswillbeyourgithub/MediaSizeOrHashMatcher): Media file comparison tool utilizing size-based matching and parallel hash computation for efficient duplicate detection across directories.
